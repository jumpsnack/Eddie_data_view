...
/**
 * Created by JUMPSNACK on 2016-07-20.
 */
public class JsonController  {
    /*Variables*/
    Vector<JSONObject> vectorAirData; /* Save air data for each time as collection */
    ...
    public boolean getJsonDataParsing() {
        try {
            ...
            for (int i = 0; i < totalRows; i++)
                vectorAirData.add(jsonDataDataArray.getJSONObject(i));
